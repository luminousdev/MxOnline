...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="image/%Y/%m", default=u"image/default.png", max_length=100, verbose_name=u"图片")
...
class EmailVerifyRecord(models.Model):
    ...
    send_time = models.DateTimeField(default=datetime.now, verbose_name=u"发送时间")  # now后加括号是编译时间，不加括号是实例化的时间
